...
class detailViewController: UIViewController, UIWebViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func getMovieDetails() {
        ...
        let request = Alamofire.request("https://api.themoviedb.org/3/movie/\(self.movieId)?api_key=01082f35da875726ce81a65b79c1d08c&append_to_response=reviews,credits,videos,images")
        request.validate()
    ...
    @IBAction func backToDetailView(segue: UIStoryboardSegue) {        
        self.loader.startAnimating()
